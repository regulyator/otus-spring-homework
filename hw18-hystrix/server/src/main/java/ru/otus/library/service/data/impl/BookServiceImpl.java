...
public class BookServiceImpl implements BookService {
    ...
    @Override
    @Secured({"ROLE_ADMIN"})
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackCreateOrUpdate")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackAddComment")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackRemoveComment")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackCreateOrUpdateBook")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackGetById")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackGetAll")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackGetByIdDto")
    ...
    @Override
    @HystrixCommand(groupKey = "bookServiceGroup", fallbackMethod = "fallbackGetAllDto")
